...
#----------------------------------------------------------------------------------------------------------------------
#  Default values for all command line arguments, all of which can be overridden by user.
#  Please keep this list sorted alphabetically.
#----------------------------------------------------------------------------------------------------------------------
: ${BS_CONFIG_ONLY:=$BS_FALSE}
: ${BS_CURL_ARGS:=}
: ${BS_CUSTOM_MASTER_CONFIG:=$BS_NULL}
: ${BS_CUSTOM_MINION_CONFIG:=$BS_NULL}
: ${BS_CUSTOM_REPO_URL:=$BS_NULL}
: ${BS_DISABLE_REPOS:=$BS_FALSE}
: ${BS_DISABLE_SALT_CHECKS:=$BS_FALSE}
: ${BS_DISABLE_SSL:=$BS_FALSE}
: ${BS_DOWNSTREAM_PKG_REPO:=$BS_FALSE}
: ${BS_ECHO_DEBUG:=$BS_FALSE}
: ${BS_ENABLE_EXTERNAL_ZMQ_REPOS:=$BS_FALSE}
: ${BS_EPEL_REPO:=epel}
: ${BS_EPEL_REPOS_INSTALLED:=$BS_FALSE}
: ${BS_EXTRA_PACKAGES:=}
: ${BS_FETCH_ARGS:=}
: ${BS_FORCE_OVERWRITE:=$BS_FALSE}
: ${BS_FORCE_SHALLOW_CLONE:=$BS_FALSE}
: ${BS_GENTOO_USE_BINHOST:=$BS_FALSE}
: ${BS_HTTP_PROXY:=}
: ${BS_INSECURE_DL:=$BS_FALSE}
: ${BS_INSTALL_CLOUD:=$BS_FALSE}
: ${BS_INSTALL_MASTER:=$BS_FALSE}
: ${BS_INSTALL_MINION:=$BS_TRUE}
: ${BS_INSTALL_SYNDIC:=$BS_FALSE}
: ${BS_KEEP_TEMP_FILES:=$BS_FALSE}
: ${BS_LIBCLOUD_MIN_VERSION:=0.14.0}
: ${BS_NO_DEPS:=$BS_FALSE}
: ${BS_PIP_ALL:=$BS_FALSE}
: ${BS_PIP_ALLOWED:=$BS_FALSE}
: ${BS_QUIET_GIT_INSTALLATION:=$BS_FALSE}
: ${BS_SALTSTACK_REPO_URL:=git://github.com/saltstack/salt.git}
: ${BS_SALT_CACHE_DIR:=/var/cache/salt}
: ${BS_SALT_ETC_DIR:=/etc/salt}
: ${BS_SALT_GIT_CHECKOUT_DIR:=/tmp/git/salt}
: ${BS_SALT_MASTER_ADDRESS:=$BS_NULL}
: ${BS_SALT_MINION_ID:=$BS_NULL}
# _SIMPLIFY_VERSION is mostly used in Solaris based distributions
: ${BS_SIMPLIFY_VERSION:=$BS_TRUE}
: ${BS_SLEEP:=$__DEFAULT_SLEEP}
: ${BS_START_DAEMONS:=$BS_TRUE}
: ${BS_TEMP_CONFIG_DIR:=$BS_NULL}
: ${BS_TEMP_KEYS_DIR:=$BS_NULL}
: ${BS_UPGRADE_SYS:=$BS_FALSE}
: ${BS_VIRTUALENV_DIR:=$BS_NULL}
: ${BS_WGET_ARGS:=}

# Dependent defaults
: ${BS_PKI_DIR:=${BS_SALT_ETC_DIR}/pki}
: ${BS_SALT_REPO_URL:=$BS_SALTSTACK_REPO_URL}
...
#----------------------------------------------------------------------------------------------------------------------
#  Handle command line arguments. Defaults are defined above.
#  Please keep this list sorted alphabetically.
#----------------------------------------------------------------------------------------------------------------------
_CONFIG_ONLY=$BS_CONFIG_ONLY
_CURL_ARGS=$BS_CURL_ARGS
_CUSTOM_MASTER_CONFIG=$BS_CUSTOM_MASTER_CONFIG
_CUSTOM_MINION_CONFIG=$BS_CUSTOM_MINION_CONFIG
_CUSTOM_REPO_URL=$BS_CUSTOM_REPO_URL
_DISABLE_REPOS=$BS_DISABLE_REPOS
_DISABLE_SALT_CHECKS=$BS_DISABLE_SALT_CHECKS
_DISABLE_SSL=$BS_DISABLE_SSL
_DOWNSTREAM_PKG_REPO=$BS_DOWNSTREAM_PKG_REPO
_ECHO_DEBUG=$BS_ECHO_DEBUG
_ENABLE_EXTERNAL_ZMQ_REPOS=$BS_ENABLE_EXTERNAL_ZMQ_REPOS
_EPEL_REPO=$BS_EPEL_REPO
_EPEL_REPOS_INSTALLED=$BS_EPEL_REPOS_INSTALLED
_EXTRA_PACKAGES=$BS_EXTRA_PACKAGES
_FETCH_ARGS=$BS_FETCH_ARGS
_FORCE_OVERWRITE=$BS_FORCE_OVERWRITE
_FORCE_SHALLOW_CLONE=$BS_FORCE_SHALLOW_CLONE
_GENTOO_USE_BINHOST=$BS_GENTOO_USE_BINHOST
_HTTP_PROXY=$BS_HTTP_PROXY
_INSECURE_DL=$BS_INSECURE_DL
_INSTALL_CLOUD=$BS_INSTALL_CLOUD
_INSTALL_MASTER=$BS_INSTALL_MASTER
_INSTALL_MINION=$BS_INSTALL_MINION
_INSTALL_SYNDIC=$BS_INSTALL_SYNDIC
_KEEP_TEMP_FILES=$BS_KEEP_TEMP_FILES
_LIBCLOUD_MIN_VERSION=$BS_LIBCLOUD_MIN_VERSION
_NO_DEPS=$BS_NO_DEPS
_PIP_ALL=$BS_PIP_ALL
_PIP_ALLOWED=$BS_PIP_ALLOWED
_PKI_DIR=$BS_PKI_DIR
_QUIET_GIT_INSTALLATION=$BS_QUIET_GIT_INSTALLATION
_SALTSTACK_REPO_URL=$BS_SALTSTACK_REPO_URL
_SALT_CACHE_DIR=$BS_SALT_CACHE_DIR
_SALT_ETC_DIR=$BS_SALT_ETC_DIR
_SALT_GIT_CHECKOUT_DIR=$BS_SALT_GIT_CHECKOUT_DIR
_SALT_MASTER_ADDRESS=$BS_SALT_MASTER_ADDRESS
_SALT_MINION_ID=$BS_SALT_MINION_ID
_SALT_REPO_URL=$BS_SALT_REPO_URL
# _SIMPLIFY_VERSION is mostly used in Solaris based distributions
_SIMPLIFY_VERSION=$BS_SIMPLIFY_VERSION
_SLEEP=$BS_SLEEP
_START_DAEMONS=$BS_START_DAEMONS
_TEMP_CONFIG_DIR=$BS_TEMP_CONFIG_DIR
_TEMP_KEYS_DIR=$BS_TEMP_KEYS_DIR
_UPGRADE_SYS=$BS_UPGRADE_SYS
_VIRTUALENV_DIR=$BS_VIRTUALENV_DIR
